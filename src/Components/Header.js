  ...
  return (
    ...
    <div className="container mx-auto px-5 py-10 relative">
        ...
        <div  className="pb-32 flex justify-between items-center">
            ...
            <div  onClick={switchLanguage} className="flex gap-1 text-zinc-500 cursor-pointer">
        ...
        <div  className="flex gap-5 items-center mb-5 md:w-80">
        ...
        {language ? 
          <h1  className="hidden md:block text-4xl font-bold md:text-7xl">Hi there, I’m Daniel, <br></br>Front End Developer.</h1> 
        : <h1  className="hidden md:block text-4xl font-bold md:text-7xl">Ahoj, jsem Daniel,<br></br>Front End Developer.</h1>
        }

        {language ? 
            <h1 className=" md:hidden text-4xl font-bold md:text-7xl">Hi there, I’m Daniel, Front End Developer.</h1> 
          : <h1 className=" md:hidden text-4xl font-bold md:text-7xl">Ahoj, jsem Daniel, Front End Developer.</h1>
          }

        <div className="flex flex-col gap-5 py-10 md:py-16 leading-8">
        ...
        <img src={notebook} className="pb-10 md:pb-16" />
    </div>
